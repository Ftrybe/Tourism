...
@Component({
  ...
  templateUrl: './food-map-dialog.component.html',
  styleUrls: ['./food-map-dialog.component.scss']
})
export class FoodMapDialogComponent implements OnInit {
  // 数据库获取地图信息
  ...
  constructor(@Optional() private dialogRef: MatDialogRef<FoodMapDialogComponent>,
