...
export const verticalMenuItems = [
  ...
  new Menu(21, 'Banner', '/manager/banner', null, 'computer', null, false, 2),
  new Menu(22, '推荐列表', '/manager/tuijian', null, 'computer', null, false, 2),
  new Menu(3, '景点管理', '/ui/buttons', null, 'keyboard', null, false, 0),
  new Menu(4, '美食管理', '/ui/cards', null, 'fastfood', null, false, 0),
  new Menu(5, '游记管理', '/ui/lists', null, 'list', null, false, 0),
  new Menu(6, '简介管理', '/ui/grids', null, 'grid_on', null, false, 0),
  new Menu(7, '用户管理', '/manager/users', null, 'account_box', null, false, 0),
  new Menu(8, '管理员管理', '/ui/tabs', null, 'account_box', null, false, 0),
];
